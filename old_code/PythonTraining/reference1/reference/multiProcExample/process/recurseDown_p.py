import multiprocessing, concurrent.futures  #in Py2, must do, pip install futures
...
if __name__ == '__main__':
    ...
    #multiprocessing.RLock() can not be pickeled, hence can not be shared when we don't have control over process creation
    manager = multiprocessing.Manager() #very heavy weight 
    pLck = manager.RLock()
    #other vars 
    sleep = 0.1
    debug = True
